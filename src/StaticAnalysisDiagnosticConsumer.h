...
/**
 * @brief Static Analysis API : Diagnostic Consumer
 *
 * @details The class StaticAnalysisDiagnosticConsumer is created by the class StaticAnalysisAction.
...
public:
     ...
     *
     * @param SM  Used to initialize the private data member of the same name.
     ...
     * It is passed from the class StaticAnalysisAction, when it creates the
     ...
     *
     * @param Diags  This is the list of diagnostics that the Clang
     ...
     *
     * @param filesMade  There is not that much documentation about this class or what
     ...
     *
     * @param loc_end  The starting location of the code text.
     *
     * @return SourceLocation - The ending location of the selected code text.
     */
