...
int32_T ee_sm_control_fab709d2_1_ds_cache_i(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t1, NeDsMethodOutput *t2)
{
  ...
  M_idx_27 = t1->mM.mX[27];
  M_idx_28 = t1->mM.mX[28];
  M_idx_29 = t1->mM.mX[29];
  M_idx_30 = t1->mM.mX[30];
  M_idx_31 = t1->mM.mX[31];
  M_idx_32 = t1->mM.mX[32];
  M_idx_33 = t1->mM.mX[33];
  M_idx_34 = t1->mM.mX[34];
  M_idx_35 = t1->mM.mX[35];
  M_idx_36 = t1->mM.mX[36];
  M_idx_37 = t1->mM.mX[37];
  M_idx_38 = t1->mM.mX[38];
  M_idx_39 = t1->mM.mX[39];
  M_idx_40 = t1->mM.mX[40];
  M_idx_41 = t1->mM.mX[41];
  out = t2->mCACHE_I;
