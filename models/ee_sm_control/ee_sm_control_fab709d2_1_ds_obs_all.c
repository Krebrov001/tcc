...
int32_T ee_sm_control_fab709d2_1_ds_obs_all(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t137, NeDsMethodOutput *t138)
{
  ...
  t0[51ULL] = X[26ULL];
  t0[52ULL] = U_idx_1;
  t0[53ULL] = (real_T)Q_idx_0;
  t0[54ULL] = X[30ULL];
  t0[55ULL] = X[24ULL];
  t0[56ULL] = t107;
  t0[57ULL] = X[27ULL];
  t0[58ULL] = U_idx_1;
  t0[59ULL] = (real_T)Q_idx_1;
  t0[60ULL] = X[31ULL];
  t0[61ULL] = X[25ULL];
  t0[62ULL] = t108;
  t0[63ULL] = X[28ULL];
  t0[64ULL] = U_idx_1;
  t0[65ULL] = (real_T)Q_idx_2;
  t0[66ULL] = X[29ULL];
  t0[67ULL] = X[30ULL];
  t0[68ULL] = X[31ULL];
  t0[69ULL] = X[23ULL];
  ...
  t0[100ULL] = X[32ULL];
  t0[101ULL] = U_idx_2;
  t0[102ULL] = (real_T)Q_idx_3;
  t0[103ULL] = X[36ULL];
  t0[104ULL] = X[24ULL];
  t0[105ULL] = t116;
  t0[106ULL] = X[33ULL];
  t0[107ULL] = U_idx_2;
  t0[108ULL] = (real_T)Q_idx_4;
  t0[109ULL] = X[37ULL];
  t0[110ULL] = X[25ULL];
  t0[111ULL] = t117;
  t0[112ULL] = X[34ULL];
  t0[113ULL] = U_idx_2;
  t0[114ULL] = (real_T)Q_idx_5;
  t0[115ULL] = X[35ULL];
  t0[116ULL] = X[36ULL];
  t0[117ULL] = X[37ULL];
  t0[118ULL] = X[23ULL];
