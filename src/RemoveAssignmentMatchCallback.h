...
/**
 * @brief CallBack class : Remove Redundant Assignments Module
 *
 * @details This class removes all lines having redundant assignments.
 * It gets these lines from the StaticAnalysisDiagnosticConsumer.
 */
class RemoveAssignmentMatchCallback : public BaseMatchCallback
{
  public:
    ...
    /**
     * @return A reference to the private data member
    ...
    /**
	 * @return the number of successful removals of unreferenced assignments.
	 */
