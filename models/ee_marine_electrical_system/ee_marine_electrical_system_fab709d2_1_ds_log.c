...
int32_T ee_marine_electrical_system_fab709d2_1_ds_log(const NeDynamicSystem *t0,
  const NeDynamicSystemInput *t281, NeDsMethodOutput *t282)
{
  PmRealVector out;
  ...
  t1[115ULL] = (real_T)Q_idx_0;
  t1[116ULL] = t213;
  t1[117ULL] = t222;
  t1[118ULL] = ((-X[85ULL] + -X[83ULL]) + X[64ULL] * 0.81649658092772615) + X
    [66ULL] * 0.57735026918962584;
  t1[119ULL] = U_idx_1;
  t1[120ULL] = Bow_Thrusters_Bow_Thurster_Breaker_breakerB_i;
  t1[121ULL] = (real_T)Q_idx_1;
  t1[122ULL] = t214;
  t1[123ULL] = X[85ULL];
  t1[124ULL] = ((-X[85ULL] + X[64ULL] * -0.408248290463863) + X[65ULL] *
                0.70710678118654757) + X[66ULL] * 0.57735026918962584;
  t1[125ULL] = U_idx_1;
  t1[126ULL] = Bow_Thrusters_Bow_Thurster_Breaker_breakerC_i;
  t1[127ULL] = (real_T)Q_idx_2;
  t1[128ULL] = t215;
  t1[129ULL] = t224;
  t1[130ULL] = (((-X[85ULL] + X[64ULL] * -0.408248290463863) + X[65ULL] *
  ...
  t1[597ULL] = t254;
  t1[598ULL] = t255;
  t1[599ULL] = (real_T)Q_idx_3;
  t1[600ULL] = t213;
  t1[601ULL] = t252;
  t1[602ULL] = X[75ULL];
  t1[603ULL] = U_idx_4;
  t1[604ULL] = t256;
  t1[605ULL] = (real_T)Q_idx_4;
  t1[606ULL] = t214;
  t1[607ULL] = t253;
  t1[608ULL] = X[133ULL];
  t1[609ULL] = U_idx_4;
  t1[610ULL] = t257;
  t1[611ULL] = (real_T)Q_idx_5;
  t1[612ULL] = t215;
  t1[613ULL] = t254;
  t1[614ULL] = X[76ULL];
  t1[615ULL] = U_idx_4;
