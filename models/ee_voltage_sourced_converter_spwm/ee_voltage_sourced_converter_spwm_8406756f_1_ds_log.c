...
int32_T ee_voltage_sourced_converter_spwm_8406756f_1_ds_log(const
  NeDynamicSystem *t0, const NeDynamicSystemInput *t97, NeDsMethodOutput *t98)
{
  ...
  t7[52ULL] = X_idx_5;
  t7[53ULL] = C_p_v;
  t7[54ULL] = -(X_idx_10 * Converter_converter_Xabc_Q1_ideal_switch_v * 0.001) /
    -1.0 * 1000.0;
  t7[55ULL] = Converter_converter_Xabc_Q1_ideal_switch_v;
  t7[56ULL] = X_idx_5;
  t7[57ULL] = U_idx_1;
  t7[58ULL] = 0.0;
  t7[59ULL] = 298.15;
  ...
  t7[76ULL] = 0.0;
  t7[77ULL] = X_idx_5;
  t7[78ULL] = -(t79 * X_idx_5 * 0.001) / -1.0 * 1000.0;
  t7[79ULL] = X_idx_5;
  t7[80ULL] = C_p_v;
  t7[81ULL] = t80;
  t7[82ULL] = t66;
  ...
  t7[100ULL] = t66;
  t7[101ULL] = C_p_v;
  t7[102ULL] = -(X_idx_13 * Converter_converter_Xabc_Q3_ideal_switch_v * 0.001) /
    -1.0 * 1000.0;
  t7[103ULL] = Converter_converter_Xabc_Q3_ideal_switch_v;
  t7[104ULL] = t66;
  t7[105ULL] = U_idx_3;
  t7[106ULL] = 0.0;
  t7[107ULL] = 298.15;
  ...
  t7[124ULL] = 0.0;
  t7[125ULL] = t66;
  t7[126ULL] = -(t66 * t83 * 0.001) / -1.0 * 1000.0;
  t7[127ULL] = t66;
  t7[128ULL] = C_p_v;
  t7[129ULL] = t84;
  t7[130ULL] = t67;
  ...
  t7[148ULL] = t67;
  t7[149ULL] = C_p_v;
  t7[150ULL] = -(X_idx_16 * Converter_converter_Xabc_Q5_ideal_switch_v * 0.001) /
    -1.0 * 1000.0;
  t7[151ULL] = Converter_converter_Xabc_Q5_ideal_switch_v;
  t7[152ULL] = t67;
  t7[153ULL] = U_idx_5;
  t7[154ULL] = 0.0;
  t7[155ULL] = 298.15;
  ...
  t7[172ULL] = 0.0;
  t7[173ULL] = t67;
  t7[174ULL] = -(t67 * t87 * 0.001) / -1.0 * 1000.0;
  t7[175ULL] = t67;
  t7[176ULL] = X_idx_5;
  t7[177ULL] = t66;
  t7[178ULL] = t67;
