...
#include "nesl_rtw.h"
#include "ee_marine_electrical_system_fab709d2_1.h"

void ee_marine_electrical_system_fab709d2_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0.001, 0, 0, 0,
    0, (SscLoggingSetting) 1, 489589489, };
  ...
  ee_marine_electrical_system_fab709d2_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "ee_marine_electrical_system/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
