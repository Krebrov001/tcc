...
int32_T ee_pwm_three_level_8ad899e3_1_ds_log(const NeDynamicSystem *t0, const
  NeDynamicSystemInput *t122, NeDsMethodOutput *t123)
{
  PmRealVector out;
  real_T C1_p_v;
  real_T C2_n_v;
  ...
  t13[308ULL] = -(X_idx_10 *
    ...
    / -1.0 * 1000.0;
  t13[309ULL] = Three_Level_Converter_converter_Xabc_Q1_ideal_switch_v;
  t13[310ULL] = X_idx_29;
  t13[311ULL] = X_idx_22;
  t13[312ULL] = t87;
  t13[313ULL] = 298.15;
  ...
  t13[331ULL] = -(X_idx_37 *
                  ...
                  0.001) / -1.0 * 1000.0;
  t13[332ULL] = Three_Level_Converter_converter_Xabc_Q10_ideal_switch_v;
  t13[333ULL] = X_idx_22;
  t13[334ULL] = X_idx_30;
  t13[335ULL] = t89;
  t13[336ULL] = 298.15;
  ...
  t13[354ULL] = -(X_idx_36 *
                  ...
                  0.001) / -1.0 * 1000.0;
  t13[355ULL] = Three_Level_Converter_converter_Xabc_Q11_ideal_switch_v;
  t13[356ULL] = X_idx_30;
  t13[357ULL] = C2_n_v;
  t13[358ULL] = t91;
  t13[359ULL] = 298.15;
  ...
  t13[377ULL] = -(X_idx_12 *
                  ...
                  0.001) / -1.0 * 1000.0;
  t13[378ULL] = Three_Level_Converter_converter_Xabc_Q12_ideal_switch_v;
  t13[379ULL] = X_idx_25;
  t13[380ULL] = X_idx_23;
  t13[381ULL] = t93;
  t13[382ULL] = 298.15;
  ...
  t13[400ULL] = -(X_idx_38 *
    ...
    / -1.0 * 1000.0;
  t13[401ULL] = Three_Level_Converter_converter_Xabc_Q2_ideal_switch_v;
  t13[402ULL] = X_idx_23;
  t13[403ULL] = X_idx_26;
  t13[404ULL] = t95;
  t13[405ULL] = 298.15;
  ...
  t13[423ULL] = -(X_idx_32 *
    ...
    / -1.0 * 1000.0;
  t13[424ULL] = Three_Level_Converter_converter_Xabc_Q3_ideal_switch_v;
  t13[425ULL] = X_idx_26;
  t13[426ULL] = C2_n_v;
  t13[427ULL] = t97;
  t13[428ULL] = 298.15;
  ...
  t13[446ULL] = -(X_idx_14 *
    ...
    / -1.0 * 1000.0;
  t13[447ULL] = Three_Level_Converter_converter_Xabc_Q4_ideal_switch_v;
  t13[448ULL] = C1_p_v;
  t13[449ULL] = X_idx_27;
  t13[450ULL] = t99;
  t13[451ULL] = 298.15;
  ...
  t13[469ULL] = -(X_idx_16 *
    ...
    / -1.0 * 1000.0;
  t13[470ULL] = Three_Level_Converter_converter_Xabc_Q5_ideal_switch_v;
  t13[471ULL] = X_idx_27;
  t13[472ULL] = X_idx_24;
  t13[473ULL] = t101;
  t13[474ULL] = 298.15;
  ...
  t13[492ULL] = -(X_idx_39 *
    ...
    / -1.0 * 1000.0;
  t13[493ULL] = Three_Level_Converter_converter_Xabc_Q6_ideal_switch_v;
  t13[494ULL] = X_idx_24;
  t13[495ULL] = X_idx_28;
  t13[496ULL] = t103;
  t13[497ULL] = 298.15;
  ...
  t13[515ULL] = -(X_idx_34 *
    ...
    / -1.0 * 1000.0;
  t13[516ULL] = Three_Level_Converter_converter_Xabc_Q7_ideal_switch_v;
  t13[517ULL] = X_idx_28;
  t13[518ULL] = C2_n_v;
  t13[519ULL] = t105;
  t13[520ULL] = 298.15;
  ...
  t13[538ULL] = -(X_idx_18 *
    ...
    / -1.0 * 1000.0;
  t13[539ULL] = Three_Level_Converter_converter_Xabc_Q8_ideal_switch_v;
  t13[540ULL] = C1_p_v;
  t13[541ULL] = X_idx_29;
  t13[542ULL] = t107;
  t13[543ULL] = 298.15;
  ...
  t13[561ULL] = -(X_idx_20 *
    ...
    / -1.0 * 1000.0;
  t13[562ULL] = Three_Level_Converter_converter_Xabc_Q9_ideal_switch_v;
  t13[563ULL] = X_idx_23;
  t13[564ULL] = X_idx_24;
  t13[565ULL] = X_idx_22;
  for (t52 = 0ULL; t52 < 24ULL; t52++) {
