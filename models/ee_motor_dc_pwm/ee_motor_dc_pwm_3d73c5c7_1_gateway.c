...
#include "nesl_rtw.h"
#include "ee_motor_dc_pwm_3d73c5c7_1.h"

void ee_motor_dc_pwm_3d73c5c7_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0.001, 0, 0, 0,
    0, (SscLoggingSetting) 1, 489585846, };

  NeSolverParameters solverparams = { 0, 0, 1, 0, 0, 0.001, 1e-06, 1e-09, 0, 0,
    100, 0, 1, 0, 1e-09, 0, (NeLocalSolverChoice) 0, 5e-06, 0, 4, 2,
  ...
  ee_motor_dc_pwm_3d73c5c7_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("ee_motor_dc_pwm/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
