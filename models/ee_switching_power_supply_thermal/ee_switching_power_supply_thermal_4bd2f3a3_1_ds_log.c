...
int32_T ee_switching_power_supply_thermal_4bd2f3a3_1_ds_log(const
  NeDynamicSystem *sys, const NeDynamicSystemInput *t5, NeDsMethodOutput *t6)
{
  ...
  t0[25ULL] = X_idx_17;
  t0[26ULL] = 30.0;
  t0[27ULL] = Diode_1_p_v;
  t0[28ULL] = -(t1 * Diode_1_v * 0.001 + t1 * t1 * 1.0E-5) / -1.0 * 1000.0;
  t0[29ULL] = X_idx_17;
  t0[30ULL] = 30.0;
  t0[31ULL] = t2;
  t0[32ULL] = Diode_1_v;
  t0[33ULL] = X_idx_3;
  t0[34ULL] = t2;
  t0[35ULL] = Diode_1_private_ohmicResistance_i;
  t0[36ULL] = t2;
  t0[37ULL] = Diode_1_p_v;
  t0[38ULL] = Diode_1_private_ohmicResistance_i * 0.01;
  t0[39ULL] = Diode_1_v;
  t0[40ULL] = Diode_1_v;
  t0[41ULL] = 298.15;
  t0[42ULL] = X_idx_14;
  t0[43ULL] = X_idx_15;
  t0[44ULL] = Diode_1_p_v;
  t0[45ULL] = 0.0;
  t0[46ULL] = -(X_idx_14 * Diode_2_v * 0.001 + X_idx_14 * X_idx_14 * 1.0E-5) /
    -1.0 * 1000.0;
  t0[47ULL] = X_idx_15;
  t0[48ULL] = Diode_1_p_v;
  t0[49ULL] = t3;
  t0[50ULL] = Diode_2_v;
  t0[51ULL] = X_idx_1;
  t0[52ULL] = t3;
  t0[53ULL] = Diode_2_private_ohmicResistance_i;
  t0[54ULL] = t3;
  t0[55ULL] = 0.0;
  t0[56ULL] = Diode_2_private_ohmicResistance_i * 0.01;
  t0[57ULL] = Diode_2_v;
  t0[58ULL] = Diode_2_v;
  t0[59ULL] = 0.0;
  t0[60ULL] = X_idx_20;
  ...
  t0[70ULL] = 0.0;
  t0[71ULL] = 0.0;
  t0[72ULL] = Driver_Half_Bridge_Driver_HO_v;
  t0[73ULL] = Diode_1_p_v;
  t0[74ULL] = Driver_Half_Bridge_Driver_LO_v;
  t0[75ULL] = 0.0;
  t0[76ULL] = X_idx_20;
  t0[77ULL] = 0.0;
  t0[78ULL] = D_idx_1;
  t0[79ULL] = D_idx_2;
  t0[80ULL] = X_idx_18;
  t0[81ULL] = Driver_Half_Bridge_Driver_iL;
  t0[82ULL] = (real_T)Q_idx_1;
  t0[83ULL] = (real_T)Q_idx_2;
  t0[84ULL] = -(X_idx_24 * 0.001 + X_idx_25 * 0.001) / -1.0 * 1000.0;
  t0[85ULL] = X_idx_24;
  t0[86ULL] = X_idx_25;
  t0[87ULL] = X_idx_20;
  ...
  t0[92ULL] = X_idx_2;
  t0[93ULL] = X_idx_2;
  t0[94ULL] = Diode_1_p_v;
  t0[95ULL] = X_idx_0;
  t0[96ULL] = ((X_idx_14 * 0.01 + X_idx_15 * 0.010001) + X_idx_0) + X_idx_1;
  t0[97ULL] = 30.0;
  t0[98ULL] = Driver_Half_Bridge_Driver_HO_v;
  t0[99ULL] = X_idx_8;
  t0[100ULL] = Diode_1_p_v;
  ...
  t0[127ULL] = X_idx_9;
  t0[128ULL] = X_idx_28 * 1000.0;
  t0[129ULL] = N_Channel_MOSFET_1_capacitor_GS_n_v;
  t0[130ULL] = X_idx_9;
  t0[131ULL] = X_idx_26;
  t0[132ULL] = 0.0;
  t0[133ULL] = X_idx_28 * -1000.0;
  t0[134ULL] = -X_idx_6 + X_idx_4;
  t0[135ULL] = X_idx_4;
  t0[136ULL] = X_idx_9;
  ...
  t0[179ULL] = X_idx_13;
  t0[180ULL] = X_idx_33 * 1000.0;
  t0[181ULL] = N_Channel_MOSFET_2_capacitor_GS_n_v;
  t0[182ULL] = X_idx_13;
  t0[183ULL] = X_idx_31;
  t0[184ULL] = 0.0;
  t0[185ULL] = X_idx_33 * -1000.0;
  t0[186ULL] = (((-X_idx_1 + X_idx_14 * -0.01) + X_idx_15 * -0.010001) +
