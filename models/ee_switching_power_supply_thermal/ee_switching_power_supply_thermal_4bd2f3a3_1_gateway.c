...
#include "nesl_rtw.h"
#include "ee_switching_power_supply_thermal_4bd2f3a3_1.h"

void ee_switching_power_supply_thermal_4bd2f3a3_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0.001, 0, 0, 0,
    0, (SscLoggingSetting) 1, 489588316, };

  NeSolverParameters solverparams = { 0, 0, 1, 0, 0, 0.001, 1e-06, 1e-09, 0, 0,
    100, 0, 1, 0, 1e-09, 0, (NeLocalSolverChoice) 0, 1e-07, 0, 12, 2,
  ...
  ee_switching_power_supply_thermal_4bd2f3a3_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "ee_switching_power_supply_thermal/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
