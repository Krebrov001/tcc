...
#include "nesl_rtw.h"
#include "ee_pwm_three_level_8ad899e3_1.h"

void ee_pwm_three_level_8ad899e3_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 2, 0.001, 0, 5e-06, 0, 0, 0,
    0, (SscLoggingSetting) 1, 489587158, };

  NeSolverParameters solverparams = { 0, 0, 1, 0, 0, 0.001, 1e-06, 1e-09, 0, 0,
    100, 0, 1, 0, 1e-09, 1, (NeLocalSolverChoice) 0, 5e-06, 0, 3, 2,
  ...
  ee_pwm_three_level_8ad899e3_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("ee_pwm_three_level/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
